...
public class UserController implements IUserController, IUserManagementService {
    private final IUserAuthService authService;
    private final IUserManagementService managementService;

    public UserController(IUserAuthService authService, IUserManagementService managementService) {
